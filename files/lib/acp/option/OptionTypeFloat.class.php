...
/**
 * OptionTypeFloat is an implementation of OptionType for integer fields.
 *
...
class OptionTypeFloat extends OptionTypeText
{
	...
	public function getFormElement(&$optionData) {
		...
		$optionData['optionValue'] = str_replace('.', WCF::getLanguage()->get('wcf.global.decimalPoint'), $optionData['optionValue']);
